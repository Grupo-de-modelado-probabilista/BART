...
# Data generation
X = rng.uniform(low=0, high=1.0, size=(10000, 7))
f_x = (
...
plt.savefig("boxplots_friedman_i4samp.png")
...
plt.savefig("loo_friedman_i4samp.png")
...
plt.savefig("friedman_i4samp_hist.png")
